...
FB_VERIFY_TOKEN = 'yada-yada'

FB_PAGE_ACCESS_TOKEN = 'PAT'

MESSENGER_RECIPIENT_ID = "Recipient ID"

UBER_SERVER_TOKEN = "Server Token"

UBER_ACCESS_TOKEN = "Access Token"
...
def fare_estimate(origin, destination, product_id):
